...
# Set the default batch image tag
BATCH_TAG="${BATCH_TAG:-dev}"
...
export BATCH_IMAGE="${BATCH_IMAGE:-ghcr.io/llm-d/llm-d-inference-scheduler-batch:${BATCH_TAG}}"
